// Chip mode flags (ym3438.h)
pub const MODE_YM2612: u32 = 0x01;    // YM2612 emulation (MD1, MD2 VA2)
pub const MODE_READMODE: u32 = 0x02;  // Status read on any port

// Envelope generator state (ym3438.c)
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
#[repr(u8)]
pub(crate) enum EgNum {
    Attack = 0,
    Decay = 1,
    Sustain = 2,
    Release = 3,
...
// Logarithmic sine ROM (256 entries)
pub(crate) const LOGSIN_ROM: [u16; 256] = [
...
// Note table: frequency number bits → note offset
pub(crate) const FN_NOTE: [u32; 16] = [
    0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 3, 3, 3, 3, 3, 3,
];

// Envelope generator step patterns (indexed by [rate_low][cycle])
pub(crate) const EG_STEPHI: [[u32; 4]; 4] = [
    [0, 0, 0, 0],
    [1, 0, 0, 0],
    [1, 0, 1, 0],
    [1, 1, 1, 0],
...
// Amplitude modulation shift amounts (indexed by AM sensitivity)
pub(crate) const EG_AM_SHIFT: [u8; 4] = [7, 3, 1, 0];

// Phase generator detune values
pub(crate) const PG_DETUNE: [u32; 8] = [16, 17, 19, 20, 22, 24, 27, 29];

// LFO pitch modulation shift table 1 (indexed by [lfo_freq][pg_fnum_bit])
pub(crate) const PG_LFO_SH1: [[u32; 8]; 8] = [
    [7, 7, 7, 7, 7, 7, 7, 7],
    [7, 7, 7, 7, 7, 7, 7, 7],
    [7, 7, 7, 7, 7, 7, 1, 1],
    [7, 7, 7, 7, 1, 1, 1, 1],
...
// LFO pitch modulation shift table 2 (indexed by [lfo_freq][pg_fnum_bit])
pub(crate) const PG_LFO_SH2: [[u32; 8]; 8] = [
    [7, 7, 7, 7, 7, 7, 7, 7],
    [7, 7, 7, 7, 2, 2, 2, 2],
    [7, 7, 7, 2, 2, 2, 7, 7],
    [7, 7, 2, 2, 7, 7, 2, 2],
...
// Operator register address offsets (Ch1–Ch6, OP1/2 then OP3/4)
pub(crate) const OP_OFFSET: [u32; 12] = [
    0x000, // Ch1 OP1/OP2
    0x001, // Ch2 OP1/OP2
    0x002, // Ch3 OP1/OP2
    0x100, // Ch4 OP1/OP2
...
// Channel register address offsets (Ch1–Ch6)
pub(crate) const CH_OFFSET: [u32; 6] = [
    0x000, // Ch1
    0x001, // Ch2
    0x002, // Ch3
    0x100, // Ch4
